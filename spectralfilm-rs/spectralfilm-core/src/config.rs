//! Global spectral constants shared across the crate.
//!
//! Mirrors `spektrafilm/config.py`.

/// First wavelength of the spectral grid (nm).
pub const WL_START: f64 = 380.0;
/// Last wavelength of the spectral grid (nm).
pub const WL_END: f64 = 780.0;
/// Step size of the spectral grid (nm).
pub const WL_STEP: f64 = 5.0;
/// Number of spectral bands: (780-380)/5 + 1 = 81.
pub const N_WL: usize = 81;

/// Number of colour channels (C, M, Y / R, G, B).
pub const N_CH: usize = 3;

/// Midgray linear reflectance reference (18% grey card).
pub const MIDGRAY: f64 = 0.184;

/// Log-exposure axis: 256 points from -3 to +4.
pub const LOG_EXPOSURE_MIN: f64 = -3.0;
pub const LOG_EXPOSURE_MAX: f64 = 4.0;
pub const N_LOG_EXPOSURE: usize = 256;

/// Returns the uniformly spaced wavelength grid as an array of f64.
...
/// Returns the log-exposure axis used for density curve interpolation.
...
// aligned to WL_START..WL_END at WL_STEP nm.
// Values taken from the CIE 2006 tabulation, resampled to 5 nm.
// Rows: wavelength index (0 = 380 nm … 80 = 780 nm).
// Columns: x̄, ȳ, z̄.
// ---------------------------------------------------------------------------
pub const CMFS: [[f64; 3]; N_WL] = [
    ...
    [0.227600, 0.914850, 0.029840],
    [0.295200, 0.954000, 0.020300],
    [0.362900, 0.980300, 0.013400],
    [0.433400, 0.994950, 0.008750],
